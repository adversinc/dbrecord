...
function () {
  ...
  _createClass(DbRecord, [{
    ...
    value: function commit() {
      ...
      sql += "".concat(this._tableName, " SET ");
      var fields = [];
      var values = [];
      ...
      if (this._raw[this._locateField] !== undefined) {
        sql += " WHERE ".concat(this._locateField, "=?");
    ...
    value: function _read(locateValue, byKey) {
      ...
      var rows = this._dbh.querySync("SELECT * FROM ".concat(this._tableName, " WHERE ").concat(field, "=? LIMIT 1"), [locateValue]);
    ...
    value: function _readByKey(keys, values) {
      ...
      var rows = this._dbh.querySync("SELECT * FROM ".concat(this._tableName, " WHERE ").concat(fields, " LIMIT 1"), values);
    ...
    value: function _initEmpty() {
      ...
      var rows = this._dbh.querySync("DESCRIBE ".concat(this._tableName));
    ...
    value: function deleteRecord() {
      this._dbh.querySync("DELETE FROM ".concat(this._tableName, " WHERE ").concat(this._locateField, " = ?"), [this[this._locateField]()]);
    }
    /**
    ...
    value: function forEach(options, cb) {
      ...
      var sql = "SELECT ".concat(this._locatefield(), " FROM ").concat(this._table());
      var where = [];
      var qparam = []; // WHERE fields
      ...
      var _dbh = _MysqlDatabase.default.masterDbh();
